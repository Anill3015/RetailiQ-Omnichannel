...
const NAV_ITEMS = [
    { to: 'findAuditLog', label: 'Find All', desc: 'View all audit logs', icon: 'bi-list-ul', color: '#10b981', bg: '#ecfdf5' },
];
...
export default function AuditLogHome() {
    ...
    const isRoot   = location.pathname === '/AuditLog' || location.pathname === '/AuditLog/';
    ...
    return (
        <div style={{ minHeight: '100vh', background: '#f1f5f9', fontFamily: 'Inter, sans-serif' }}>
            ...
            <div className="container-fluid px-4 py-4">
                <h1 style={{ fontSize: 24, fontWeight: 700, color: '#0f172a', margin: '0 0 4px', letterSpacing: '-0.4px' }}>Audit Logs</h1>
                <p style={{ fontSize: 13, color: '#64748b', margin: '0 0 24px' }}>Track activity · Monitor actions · Audit trail</p>
                        ...
                        {isRoot ? (
                            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '40px 24px', textAlign: 'center' }}>
                                <div style={{ width: 60, height: 60, borderRadius: 18, background: '#ecfdf5', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: 16 }}>
                                    <i className="bi bi-journal-text" style={{ fontSize: 26, color: '#10b981' }}></i>
                                </div>
                                <h2 style={{ fontSize: 17, fontWeight: 700, color: '#0f172a', margin: '0 0 6px' }}>Welcome to Audit Logs</h2>
