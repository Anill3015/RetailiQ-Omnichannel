...
const NAV_ITEMS = [
    { to: 'createCustomerProfile',   label: 'Add',          desc: 'Create customer profile',   icon: 'bi-plus-lg',        color: '#6366f1', bg: '#eef2ff' },
    { to: 'findCustomerProfile',     label: 'Find All',     desc: 'View all profiles',         icon: 'bi-list-ul',        color: '#10b981', bg: '#ecfdf5' },
    { to: 'findCustomerProfileById', label: 'Find By ID',   desc: 'Search by customer ID',     icon: 'bi-search',         color: '#3b82f6', bg: '#eff6ff' },
    { to: 'loyaltyTier',             label: 'Loyalty Tier', desc: 'Calculate loyalty tier',    icon: 'bi-award-fill',     color: '#f59e0b', bg: '#fffbeb' },
    { to: 'customerHistory',         label: 'History',      desc: 'Recommendation history',    icon: 'bi-clock-history',  color: '#8b5cf6', bg: '#f5f3ff' },
];
...
export default function CustomerProfileHome() {
    ...
    const isRoot   = location.pathname === '/CustomerProfile' || location.pathname === '/CustomerProfile/';
    ...
    useEffect(() => {
        ...
        .then(res => setTotalCustomers(res.data.length))
        ...
        <div style={{ minHeight: '100vh', background: '#f1f5f9', fontFamily: 'Inter, sans-serif' }}>
            ...
            <div className="container-fluid px-4 py-4">
                ...
                <p style={{ fontSize: 13, color: '#64748b', margin: '0 0 24px' }}>
                    Manage profiles · Loyalty tiers · Recommendations · History
                    &nbsp;
                    <span style={{
                        ...
                        return (
                            <div key={item.to} className="col-6 col-md-4 col-lg-2">
                                <Link to={item.to} style={{ textDecoration: 'none' }}>
                                    <div
                                        className="cp-card card border h-100"
                                        style={{
                                            borderRadius: 14,
                        ...
                        {isRoot ? (
                            <div style={{
                                ...
                                <div style={{
                                    ...
                                    <i className="bi bi-person-fill" style={{ fontSize: 26, color: '#6366f1' }}></i>
                                </div>
                                <h2 style={{ fontSize: 17, fontWeight: 700, color: '#0f172a', margin: '0 0 6px' }}>
                                    Welcome to Customer Profile Module
                                </h2>
