...
const NAV_ITEMS = [
    { to: 'createNotification',   label: 'Add',        desc: 'Create notification',   icon: 'bi-plus-lg',           color: '#6366f1', bg: '#eef2ff' },
    { to: 'findNotificationById', label: 'Find by ID', desc: 'Search by ID',          icon: 'bi-search',            color: '#3b82f6', bg: '#eff6ff' },
    { to: 'findAllNotification',  label: 'Find All',   desc: 'View all records',      icon: 'bi-list-ul',           color: '#10b981', bg: '#ecfdf5' },
    { to: 'unreadNotifications',  label: 'Unread',     desc: 'Unread alerts',         icon: 'bi-envelope-open-fill',color: '#ef4444', bg: '#fef2f2', badge: true },
    { to: 'sendNotification',     label: 'Send',       desc: 'Dispatch notification', icon: 'bi-send-fill',         color: '#f59e0b', bg: '#fffbeb' },
];
...
const globalStyles = `
  ...
  .nh-nav-search-wrap .nh-nav-search,
  .nh-nav-search-wrap .nh-nav-search:focus,
  .nh-nav-search-wrap .nh-nav-search:active,
  .nh-nav-search-wrap .nh-nav-search:hover {
...
export default function NotificationHome() {
    ...
    const isRoot   = location.pathname === '/Notification' || location.pathname === '/Notification/';
    ...
    return (
        <div style={{ minHeight: '100vh', background: '#f1f5f9', fontFamily: 'Inter, sans-serif' }}>
            ...
            >
                ...
                {/* Search */}
                <div className="nh-nav-search-wrap" style={{ position: 'relative' }}>
                    ...
                    <input
                        type="text"
                        className="form-control form-control-sm nh-nav-search"
            ...
            <div className="container-fluid px-4 py-4">
                ...
                <p style={{ fontSize: 13, color: '#64748b', margin: '0 0 24px' }}>
                    Manage notifications · Alerts · Messages
                </p>
                        ...
                        return (
                            <div key={item.to} className="col-6 col-md-4 col-lg-2">
                                <Link to={item.to} style={{ textDecoration: 'none' }}>
                                    <div
                                        className="nh-card card border h-100"
                                        style={{
                                            borderRadius: 14,
                                            borderColor: isActive ? '#6366f1' : '#e2e8f0',
                                            background: isActive ? item.bg : '#fff',
                                            boxShadow: isActive ? `0 8px 24px ${item.color}25` : 'none',
                                            overflow: 'hidden',
                                            position: 'relative',
                                        }}
                                        onMouseEnter={e => {
                                    ...
                                    >
                                        ...
                                        <div className="card-body p-3">
                                            ...
                                            <div style={{ fontSize: 12, fontWeight: 700, color: '#0f172a', letterSpacing: '-0.2px', marginBottom: 2 }}>
                                                {item.label}
                                            </div>
                        ...
                        {isRoot ? (
                            <div style={{
                                ...
                                <div style={{
                                    ...
                                    <i className="bi bi-bell-fill" style={{ fontSize: 26, color: '#6366f1' }}></i>
                                </div>
                                <h2 style={{ fontSize: 17, fontWeight: 700, color: '#0f172a', margin: '0 0 6px' }}>
                                    Welcome to Notification Module
                                </h2>
