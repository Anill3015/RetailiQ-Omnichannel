...
const NAV_ITEMS = [
    { to: 'createForecast',   label: 'Add',          desc: 'Create forecast',        icon: 'bi-plus-lg',        color: '#6366f1', bg: '#eef2ff' },
    { to: 'findForecast',     label: 'Find All',     desc: 'View all forecasts',     icon: 'bi-list-ul',        color: '#10b981', bg: '#ecfdf5' },
    { to: 'findForecastById', label: 'Find By ID',   desc: 'Search by forecast ID',  icon: 'bi-search',         color: '#3b82f6', bg: '#eff6ff' },
    { to: 'safetyStock',      label: 'Safety Stock', desc: 'Calculate safety stock', icon: 'bi-calculator-fill',color: '#f59e0b', bg: '#fffbeb' },
];
...
export default function ForecastHome() {
    ...
    const isRoot   = location.pathname === '/Forecast' || location.pathname === '/Forecast/';
    ...
    useEffect(() => {
        ...
        .then(res => setTotalForecasts(res.data.length))
        .catch(err => console.error('Forecast count error:', err));
    }, []);
        ...
        <div style={{ minHeight: '100vh', background: '#f1f5f9', fontFamily: 'Inter, sans-serif' }}>
            ...
            <div className="container-fluid px-4 py-4">
                ...
                <p style={{ fontSize: 13, color: '#64748b', margin: '0 0 24px' }}>
                    Demand forecasting · Safety stock · Inventory planning
                    &nbsp;
                    <span style={{
                        ...
                        return (
                            <div key={item.to} className="col-6 col-md-4 col-lg-3">
                                <Link to={item.to} style={{ textDecoration: 'none' }}>
                                    <div
                                        className="fc-card card border h-100"
                                        style={{
                                            borderRadius: 14,
                        ...
                        {isRoot ? (
                            <div style={{
                                ...
                                <div style={{
                                    ...
                                    <i className="bi bi-graph-up-arrow" style={{ fontSize: 26, color: '#6366f1' }}></i>
                                </div>
                                <h2 style={{ fontSize: 17, fontWeight: 700, color: '#0f172a', margin: '0 0 6px' }}>
                                    Welcome to Forecast Module
                                </h2>
