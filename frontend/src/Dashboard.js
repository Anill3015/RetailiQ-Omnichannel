...
const ALL_MODULES = [
    ...
    { key: 'inventory',             label: 'Inventory',             desc: 'Stock management',        route: '/Inventory',              icon: 'bi-archive-fill',           color: '#f59e0b', bg: '#fffbeb', section: 'Operations' },
    ...
    { key: 'pendingUsers',          label: 'User Approvals',        desc: 'Pending approvals',       route: '/pendingUsers',           icon: 'bi-person-check-fill',      color: '#64748b', bg: '#f8fafc', section: 'Admin' },
