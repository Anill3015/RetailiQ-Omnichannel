...
const NAV_ITEMS = [
    { to: 'createRecommendation',   label: 'Add',        desc: 'Create recommendation',    icon: 'bi-plus-lg',          color: '#6366f1', bg: '#eef2ff' },
    { to: 'findRecommendation',     label: 'Find All',   desc: 'View all recommendations', icon: 'bi-list-ul',          color: '#10b981', bg: '#ecfdf5' },
    { to: 'findRecommendationById', label: 'Find By ID', desc: 'Search by rec ID',         icon: 'bi-search',           color: '#3b82f6', bg: '#eff6ff' },
];
...
export default function RecommendationHome() {
    ...
    const isRoot   = location.pathname === '/Recommendation' || location.pathname === '/Recommendation/';
    ...
    useEffect(() => {
        ...
        .then(res => setTotalRecs(res.data.length))
        .catch(err => console.error('Recommendation count error:', err));
    }, []);
        ...
        <div style={{ minHeight: '100vh', background: '#f1f5f9', fontFamily: 'Inter, sans-serif' }}>
            ...
            <div className="container-fluid px-4 py-4">
                ...
                <p style={{ fontSize: 13, color: '#64748b', margin: '0 0 24px' }}>
                    Personalized recommendations · SKU suggestions · Customer insights
                    &nbsp;
                    <span style={{
                ...
                <div className="row g-3 mb-4">
                    {NAV_ITEMS.map(item => {
                        ...
                        return (
                            <div key={item.to} className="col-6 col-md-4 col-lg-4">
                                <Link to={item.to} style={{ textDecoration: 'none' }}>
                                    <div
                                        className="rc-card card border h-100"
                                        style={{
                                            borderRadius: 14,
                        ...
                        {isRoot ? (
                            <div style={{
                                ...
                                <div style={{
                                    ...
                                    <i className="bi bi-stars" style={{ fontSize: 26, color: '#6366f1' }}></i>
                                </div>
                                <h2 style={{ fontSize: 17, fontWeight: 700, color: '#0f172a', margin: '0 0 6px' }}>
                                    Welcome to Recommendation Module
                                </h2>
