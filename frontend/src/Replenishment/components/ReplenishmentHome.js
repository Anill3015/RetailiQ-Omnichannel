...
const NAV_ITEMS = [
    { to: 'createReplenishment',   label: 'Add',                desc: 'Create replenishment order',  icon: 'bi-plus-lg',          color: '#6366f1', bg: '#eef2ff' },
    { to: 'findReplenishment',     label: 'Find All',           desc: 'View all orders',             icon: 'bi-list-ul',          color: '#10b981', bg: '#ecfdf5' },
    { to: 'findReplenishmentById', label: 'Find By ID',         desc: 'Search by order ID',          icon: 'bi-search',           color: '#3b82f6', bg: '#eff6ff' },
    { to: 'generateReplenishment', label: 'Generate Forecast',  desc: 'Auto-generate from forecast', icon: 'bi-lightning-fill',   color: '#f59e0b', bg: '#fffbeb' },
];
...
export default function ReplenishmentHome() {
    ...
    const isRoot   = location.pathname === '/Replenishment' || location.pathname === '/Replenishment/';
    ...
    useEffect(() => {
        ...
        .catch(err => console.error('Replenishment count error:', err));
    }, []);
        ...
        <div style={{ minHeight: '100vh', background: '#f1f5f9', fontFamily: 'Inter, sans-serif' }}>
            ...
            <div className="container-fluid px-4 py-4">
                ...
                <p style={{ fontSize: 13, color: '#64748b', margin: '0 0 24px' }}>
                    Inventory replenishment · Stock transfers · Forecast-based ordering
                    &nbsp;
                    <span style={{
                        ...
                        return (
                            <div key={item.to} className="col-6 col-md-4 col-lg-3">
                                <Link to={item.to} style={{ textDecoration: 'none' }}>
                                    <div
                                        className="rp-card card border h-100"
                                        style={{
                                            borderRadius: 14,
                        ...
                        {isRoot ? (
                            <div style={{
                                ...
                                <div style={{
                                    ...
                                    <i className="bi bi-arrow-repeat" style={{ fontSize: 26, color: '#6366f1' }}></i>
                                </div>
                                <h2 style={{ fontSize: 17, fontWeight: 700, color: '#0f172a', margin: '0 0 6px' }}>
                                    Welcome to Replenishment Module
                                </h2>
