...
const NAV_ITEMS = [
    { to: 'createIntegrationEndpoint',   label: 'Add',        desc: 'Create endpoint',    icon: 'bi-plus-lg',       color: '#6366f1', bg: '#eef2ff' },
    { to: 'findIntegrationEndpointById', label: 'Find by ID', desc: 'Search by ID',       icon: 'bi-search',        color: '#3b82f6', bg: '#eff6ff' },
    { to: 'findAllIntegrationEndpoint',  label: 'Find All',   desc: 'View all endpoints', icon: 'bi-list-ul',       color: '#10b981', bg: '#ecfdf5' },
];
...
const globalStyles = `
  ...
  .ie-nav-search-wrap .ie-nav-search,
  .ie-nav-search-wrap .ie-nav-search:focus,
  .ie-nav-search-wrap .ie-nav-search:active,
  .ie-nav-search-wrap .ie-nav-search:hover {
...
export default function IntegrationEndpointHome() {
    ...
    const isRoot   = location.pathname === '/IntegrationEndpoint' || location.pathname === '/IntegrationEndpoint/';
    ...
    return (
        <div style={{ minHeight: '100vh', background: '#f1f5f9', fontFamily: 'Inter, sans-serif' }}>
            ...
            >
                ...
                {/* Search */}
                <div className="ie-nav-search-wrap" style={{ position: 'relative' }}>
                    ...
                    <input
                        type="text"
                        className="form-control form-control-sm ie-nav-search"
            ...
            <div className="container-fluid px-4 py-4">
                ...
                <p style={{ fontSize: 13, color: '#64748b', margin: '0 0 24px' }}>
                    Manage integrations · API endpoints · Connections
                </p>
                        ...
                        return (
                            <div key={item.to} className="col-6 col-md-4 col-lg-2">
                                <Link to={item.to} style={{ textDecoration: 'none' }}>
                                    <div
                                        className="ie-card card border h-100"
                                        style={{
                                            borderRadius: 14,
                        ...
                        {isRoot ? (
                            <div style={{
                                ...
                                <div style={{
                                    ...
                                    <i className="bi bi-plug-fill" style={{ fontSize: 26, color: '#6366f1' }}></i>
                                </div>
                                <h2 style={{ fontSize: 17, fontWeight: 700, color: '#0f172a', margin: '0 0 6px' }}>
                                    Welcome to Integration Module
                                </h2>
