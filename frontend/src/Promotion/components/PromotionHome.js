...
const NAV_ITEMS = [
    { to: 'createPromotion',   label: 'Add',        desc: 'Create promotion',    icon: 'bi-plus-lg', color: '#6366f1', bg: '#eef2ff' },
    { to: 'findPromotion',     label: 'Find All',   desc: 'View all promotions', icon: 'bi-list-ul', color: '#10b981', bg: '#ecfdf5' },
    { to: 'findPromotionById', label: 'Find By ID', desc: 'Search by ID',        icon: 'bi-search',  color: '#3b82f6', bg: '#eff6ff' },
];
...
export default function PromotionHome() {
    ...
    const isRoot   = location.pathname === '/Promotion' || location.pathname === '/Promotion/';
    ...
    return (
        <div style={{ minHeight: '100vh', background: '#f1f5f9', fontFamily: 'Inter, sans-serif' }}>
            ...
            <div className="container-fluid px-4 py-4">
                <h1 style={{ fontSize: 24, fontWeight: 700, color: '#0f172a', margin: '0 0 4px', letterSpacing: '-0.4px' }}>Promotion</h1>
                <p style={{ fontSize: 13, color: '#64748b', margin: '0 0 24px' }}>Manage promotions · Discounts · Offers</p>
                        ...
                        {isRoot ? (
                            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '40px 24px', textAlign: 'center' }}>
                                <div style={{ width: 60, height: 60, borderRadius: 18, background: '#eef2ff', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: 16 }}>
                                    <i className="bi bi-percent" style={{ fontSize: 26, color: '#6366f1' }}></i>
                                </div>
                                <h2 style={{ fontSize: 17, fontWeight: 700, color: '#0f172a', margin: '0 0 6px' }}>Welcome to Promotion</h2>
